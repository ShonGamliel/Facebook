import "./ReplyReply.css";
import React from "react";
import FloatReactions from "./FloatReactions";
export default function ReplyReply({ replyReply, newReplyReplyRef, setReplyBackground }) {
  ...
  return (
    <div className="reply-reply-container">
      <div className="reply-reply-line"></div>
      <div className="reply">
        <svg
        ...
        <div className="comment-center">
          <div className="reply-content">
            ...
            <div className="comment-content-text">{replyReply.text}</div>
          </div>
        </div>
      ...
      <div className="reply-buttons">
        ...
        <div
          ...
          onClick={() => {
            setReplyBackground("#E7F3FF");
            newReplyReplyRef.current.focus();
            setTimeout(() => setReplyBackground("#f0f2f5"), 3000);
          }}
        >
          Reply
        </div>
